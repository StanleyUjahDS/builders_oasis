              ...
              child: GNav(
                ...
                tabs: [
                  GButton(
                    icon: Icons.home,
                    text: "Home",
                    leading: _icon(Icons.home, currentIndex == 0),
                  ),
                  GButton(
                    icon: Icons.school,
                    text: "Learning",
                    leading: _icon(Icons.school, currentIndex == 1),
                  ),
                  GButton(
                    icon: Icons.access_time,
                    text: "Reminder",
                    leading: _icon(Icons.access_time, currentIndex == 2),
                  ),
                  GButton(
                    icon: Icons.settings,
                    text: "Settings",
                    leading: _icon(Icons.settings, currentIndex == 3),
                  ),
                ],
              ),
            ),
